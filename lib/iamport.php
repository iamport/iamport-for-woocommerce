    ...
    class WooIamport
    {
        ...
        public function sbcr_foreign($data)
        {
            try {
                ...
                $keys = array_flip(array('merchant_uid', 'amount', 'vat', 'card_number', 'expiry', 'cvc', 'name', 'buyer_name', 'buyer_email', 'buyer_tel', 'notice_url'));
                $onetime_data = array_intersect_key($data, $keys);
        ...
        private function getResponse($request_url, $request_data = null)
        {
            ...
            if (!empty($request_data)) $request_url = $request_url . "?" . http_build_query($request_data);
