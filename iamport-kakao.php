...
class WC_Gateway_Iamport_Kakao extends Base_Gateway_Iamport {
	...
	public function __construct() {
		...
		$this->supports = array( 'products', 'refunds', 'subscriptions', 'subscription_reactivation'/*이것이 있어야 subscription 후 active상태로 들어갈 수 있음*/, 'subscription_suspension', 'subscription_cancellation', 'subscription_date_changes', 'subscription_amount_changes', 'multiple_subscriptions' );
